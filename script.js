...
if (window.navigator.brave != undefined) {
    if(window.navigator.brave.isBrave.name == "isBrave") {
      if(userLang=== "pt-BR") {
        window.alert("O navegador Brave bloqueia algumas funcionalidades do jogo. por favor tente acessar de outro navegador")
      }else{
        window.alert("the Brave browser blocks some features of the game please try to access from another browser")
